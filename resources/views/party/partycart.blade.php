...
<div class="col-md-8">
                                ...
                                @foreach ($item as $value)
                                    ...
                                    <tr>
                                        <td  style="width:50px;"> 
                                          ...
                                          <input type="hidden" class="form-control" id="id{{$i}}" name="id[]" value="{{ $value->id}}">
                ...
                <div class="row">
                  ...
                  <span class="text-md float-left">Total Products  </span>
                      <span  class="text-md float-right"  id="subqty"  name="subqty">{{$totalqty}}</span>
                ...
                <div class="row">
                  ...
                  <span class="text-md float-left text-bold">SubTotal</span>
                      <span  class="text-md float-right"  id="subtotal" name="subtotal">{{$total}} </span>
                ...
                <div class="row">
                  ...
                  <span class="text-md float-left ">Tax</span>
                      <span  class="text-md float-right" id="tax" >{{$taxpercentage->tax}} %</span>
                ...
                <div class="row">
                  ...
                  <span class="text-md float-left">Tax Amount</span>
                      <span   class="text-md float-right" name="taxamount"  id="taxamount">{{intval($tax)}}</span>
                      <input type="hidden"id="amount"  name="taxamount" value="{{intval($tax)}}">
                  </p>
                </div>
                <div class="row">
                  <p class="ml-auto col-sm   ">
                  <span class="text-md float-left text-bold">Final Total</span>
                      <span class="text-md float-right" id="finaltotal" name="finaltotal">{{intval($total +$tax)}}</span>
                      <input type="hidden"id="final" name="finaltotal" value="{{intval($total +$tax)}}">
                  </p>
                </div>
                    </div>
                    <div class="card-footer">
                      <button type="submit" class="btn btn-warning btn-block">purchace all
                </div>
